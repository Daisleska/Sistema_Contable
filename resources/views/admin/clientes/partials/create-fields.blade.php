...
<div class="row" style="margin-left: 1cm;">
    <div class="form-group mb-3">
                        ...
                        <input style="width: 310px; margin-left: 0.3cm; " type="text" name="nombre" title="Ingrese el nombre" class="form-control" placeholder="" required>
  ...
  <div class="row" style="margin-left: 1cm;">
    ...
    <div class="row" style="margin-left: 1cm;">         
                <div class="form-group mb-3">
                        ...
                        <input style="width: 310px; margin-left: 0.3cm; " type="email" class="form-control" title="Ingrese el correo"  name="email" placeholder="correo@gmail.com" required>
                        <div class="valid-feedback">
