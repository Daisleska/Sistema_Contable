...
<div class="row" style="margin-left: 1cm;">
    <div class="form-group mb-3">
                        ...
                        <input style="width: 310px; margin-left: 0.3cm; " type="text" name="nombre" title="Ingrese el nombre" class="form-control" placeholder="EICHE" required>
  ...
  <div class="row" style="margin-left: 1cm;">
                    <div class="form-group mb-3">
                        <label style="margin-left: 0.3cm;">RUT *</label>
                            <select name="tipo_documento" data-plugin="customselect" title="Seleccione el tipo de documento" class="form-control" data-placeholder="" required="required" style="width: 80px; margin-left: 0.3cm; " >
    ...
    <div class="row" style="margin-left: 1cm;">         
                <div class="form-group mb-3">
                        ...
                        <input style="width: 310px; margin-left: 0.3cm; " type="email" class="form-control" title="Ingrese el correo"  name="email" placeholder="eiche@gmail.com" required>
                        <div class="valid-feedback">
    ...
    <div class="row" style="margin-left: 1cm;">
                    <div class="form-group mb-3">
                        <label style="margin-left: 0.3cm;">Teléfono *</label>
                            ...
                            <select name="codigo" data-plugin="customselect" class="form-control" title="Seleccione el código" data-placeholder="" required="required" style="width: 80px; margin-left: 0.3cm; " >
