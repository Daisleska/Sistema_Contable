        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="dropdown-menu dropdown-menu-right">
                    ...
                    <a href="{{ route('cargos.pdf') }}" class="dropdown-item notify-item">
              ...
              @foreach($cargos as $key)
                <tr>
                 ...
                 @if(buscar_p('Registros Generales','Modificar')=="Si" || buscar_p('Registros Generales','Eliminar')=="Si")
                    <button type="button" class="btn btn-info btn-xs" title="Editar"><a href="{{ route('cargos.edit',$key->id) }}"><i data-feather="edit"></i></a></button>
                                            ...
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h4 class="header-title mt-0 mb-1"style="margin-left: 2.9cm;"  id="myCenterModalLabel">Información de los Cargos</h4>
...
<script type="text/javascript">
 ...
 <script type="text/javascript">
  ...
  function detalles(id, nombre, tipo){
