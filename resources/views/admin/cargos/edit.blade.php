...
<div class="row" style=" align-items: center; justify-content: center;">
    <div class="col-md-6">
        <div class="card">
            <div class="card-body">
              <br>
                <h4 style="text-align: center;" class="header-title mt-0 mb-1">Modificar Cargos</h4>
                <p class="sub-header"></p>
    
                <div class="box-body abs-center">
              {!! Form::open(['route' => ['cargos.update',$cargos->id], 'method' => 'PUT', 'name' => 'form', 'id' => 'form','data-parsley-validate']) !!}
                  @csrf
