...
<body>
    ...
    <h2 style="text-align: center;">Productos</h2> <br>
...
<table border="1" width="500">
                        <thead>
                            <tr>
                                ...
                                <th id="alto">Stock Mínimo</th>
                                <th id="alto">Stock Máximo</th>
                            </tr>
                        </thead>
                ...
                <tr>
                  ...
                  <td id="c">{{$key->existencia}}</td>
                  <td id="c">{{$key->unidad}}</td>
                  <td id="c">{{number_format($key->precio,2,',','.')}}</td>
                  <td id="c">{{$key->stock_min}}</td>
                  <td id="c">{{$key->stock_max}}</td>
