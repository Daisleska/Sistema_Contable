...
<div class="right-bar">
    ...
    <div class="slimscroll-menu">
        ...
        <h5 class="font-size-16 pl-3 mt-4">Elije Tema</h5>
        <div class="p-3">
            <h6>Default</h6>
            <a href="/"><img src="{{ URL::asset('Shreyu/assets/images/layouts/vertical.jpg') }}" alt="vertical" class="img-thumbnail demo-img" /></a>
        </div>
        <div class="px-3 py-1">
            <h6>Top Nav</h6>
